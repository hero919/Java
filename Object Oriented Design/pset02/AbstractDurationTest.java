...
/**
 * Defines tests for `AbstractDuration`s, without knowing or caring which
 * concrete implementation is being tested. We can then subclass this and
 * override the `zero` method to specify how to obtain a zero duration for
 * the class we would like to test.
 */
public abstract class AbstractDurationTest {
  ...
  */
  ...
  /*
   * We should have more tests for everything, including tests for `hashCode`
   * and `compareTo`.
   */
}
