  ...
  implements Boundable, Interpolable<BoundingBox>, Transformable<BoundingBox>
{
  ...
  /**
   * Gets the y coordinate of the top of this bounding box,
   * rounded down to the nearest {@code int}.
   *
  ...
  /**
   * Gets the y coordinate of the bottom of this bounding box,
   * rounded up to the nearest {@code int}.
   *
  ...
  /**
   * Transforms a bounding box according to an affine transformation. Note
   * that this does not transform the box as a rectangle,
   * since bounding boxes are orthogonal to the axes.
   * Rather, it finds the minimal bounding box for this bounding box
   * transformed as a rectangle, which may be larger than this bounding box.
   *
